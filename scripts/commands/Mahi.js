...
module.exports🫂.run = async ({
  ...
  if (_0x47ac54.join() == '') {
    return _0x3bec5f.sendMessage(" Hey ,I am mesenger bot  😎 \n\n আমাকে ব্যাবহার করতে [bot]লিখে কিছু জিগ্গেস করুন 🤗 \n\n [𝐎𝐖𝐍𝐄𝐑:☞o⃢        m⃢        o⃢        r⃢         a⃢        l⃢        v⃢        i⃢ (✷‿✷)☜ 😼 ", _0x43a287.threadID, _0x43a287.messageID);
  } else {
