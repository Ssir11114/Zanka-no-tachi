...
module.exports.run = async function({ api, event, Users }) {
  ...
  if (event.logMessageData.addedParticipants && Array.isArray(event.logMessageData.addedParticipants) && event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    let gifUrl = 'https://i.postimg.cc/nL6kG7pn/Copy-of-download.gif';
...
DEVELOPER : EASIR IQBAL MAHI

🟣Facebook Account Link: 

https://www.facebook.com/100072881080249

🔵WHATSAPP NUMBER: wa.me/+8801712918055

🟢SUPPORT EMAIL: easiriqbalmahi@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://i.imgur.com/Fghxs7n.jpg',
          'https://i.imgur.com/NbkPt9V.png',
          'https://i.imgur.com/9ew79FI.mp4',
          'https://i.imgur.com/Yh9sWFV.jpg',
          'https://i.imgur.com/a3MqlYa.jpg'
        ]
